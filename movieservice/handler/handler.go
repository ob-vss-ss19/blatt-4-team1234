...
func (handle *MovieHandler) GetAllMovies(ctx context.Context,req *movie.GetAllMoviesRequest,rsp *movie.GetAllMoviesResponse) error {
	var protoMovies []*movie.Movie
...
func (handle *MovieHandler) GetMovie(ctx context.Context,req *movie.GetMovieRequest,rsp *movie.GetMovieResponse) error {
...
func (handle *MovieHandler) AddMovie(ctx context.Context,req *movie.AddMovieRequest,rsp *movie.AddMovieResponse) error {
	handle.Movies[int64(len(handle.Movies)+1)] = Movie{Title:req.Movie.Title,Fsk:req.Movie.Fsk}
	return nil
}

func (handle *MovieHandler) RemoveMovie(ctx context.Context,req *movie.RemoveMovieRequest,rsp *movie.RemoveMovieResponse) error {
