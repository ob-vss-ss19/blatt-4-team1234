...
type ReservationService interface {
	...
	RemoveReservationsForShow(ctx context.Context, in *RemoveReservationForShowRequest, opts ...client.CallOption) (*RemoveReservationForShowResponse, error)
}
...
func (c *reservationService) RemoveReservationsForShow(ctx context.Context, in *RemoveReservationForShowRequest, opts ...client.CallOption) (*RemoveReservationForShowResponse, error) {
	req := c.c.NewRequest(c.name, "ReservationService.RemoveReservationsForShow", in)
	out := new(RemoveReservationForShowResponse)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
	}
...
type ReservationServiceHandler interface {
	...
	RemoveReservationsForShow(context.Context, *RemoveReservationForShowRequest, *RemoveReservationForShowResponse) error
}
...
func RegisterReservationServiceHandler(s server.Server, hdlr ReservationServiceHandler, opts ...server.HandlerOption) error {
	type reservationService interface {
		...
		RemoveReservationsForShow(ctx context.Context, in *RemoveReservationForShowRequest, out *RemoveReservationForShowResponse) error
	}
	type ReservationService struct {
		reservationService
	}
...
func (h *reservationServiceHandler) RemoveReservationsForShow(ctx context.Context, in *RemoveReservationForShowRequest, out *RemoveReservationForShowResponse) error {
	return h.ReservationServiceHandler.RemoveReservationsForShow(ctx, in, out)
}
